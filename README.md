...
[![CI](https://github.com/kollorg/quod-autem-neque/workflows/CI/badge.svg)](https://github.com/kollorg/quod-autem-neque/actions/workflows/ci.yml)
[![NPM version](https://img.shields.io/npm/v/@kollorg/quod-autem-neque.svg?style=flat)](https://www.npmjs.com/package/@kollorg/quod-autem-neque)
...
resources that demonstrate the use of @kollorg/quod-autem-neque in different use-cases and scenarios:

* A reference application using [Fastify with @kollorg/quod-autem-neque and dotenv](https://github.com/lirantal/fastify-dotenv-envschema-example)
